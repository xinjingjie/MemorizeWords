...
import com.example.memorizewords.WordClickListener;
...
public class WordAdapter extends RecyclerView.Adapter<WordAdapter.MyViewHolder> {
    ...
    public WordAdapter(boolean isCard, WordViewModel wordViewModel) {
        this.isCard = isCard;
    ...
    public void setWordsList(List<Word> wordsList) {
        ...
        Log.d("ALLWORD", "setWordsList: " + this.wordsList);
    }
    ...
    static class MyViewHolder extends RecyclerView.ViewHolder {
        TextView id, chinese_mean, english_mean;
        Switch aSwitch;
